...
> Release track option B. Through #5 + #6 origin pin + VERIFY-ACCT-1 shipped. Agents on `/api/test/*` hard-404. Your open work = calendar callback URI + **one** Google verification when live.
