...
> Release track option B. Through #5 + three #6 security chunks shipped. Agents on **SMOKE-PRIV-1** (shared-device learner logout). Your open work = calendar callback URI + **one** Google verification when live.
