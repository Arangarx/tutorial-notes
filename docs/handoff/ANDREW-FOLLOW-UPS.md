...
| #4 | Email OTP 2FA (TOTP stays) | Branch [`feat/email-otp-2fa-enroll`](https://github.com/Arangarx/tutoring-notes/tree/feat/email-otp-2fa-enroll) — **verify REJECT**; adding auth-boundary Jest (rollback / step-up / rate-limit) |
