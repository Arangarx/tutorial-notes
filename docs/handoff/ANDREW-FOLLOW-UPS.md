...
| #3 leftover | Waitlist REJECTED + revoke | **verify REJECT** — migration timestamp fix in flight on [`feat/tutor-waitlist-rejected-revoke`](https://github.com/Arangarx/tutoring-notes/tree/feat/tutor-waitlist-rejected-revoke) |
