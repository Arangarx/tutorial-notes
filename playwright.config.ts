  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: [
        ...
        "**/integration/wb-e4-pdf-board-stroke-leak.spec.ts",
        "**/integration/wb-e5-pdf-board-stroke-bleed-initial-board.spec.ts",
