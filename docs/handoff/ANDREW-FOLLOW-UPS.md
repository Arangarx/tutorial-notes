...
| #6 | Security MUST for strangers | Origin pin **DONE** [`0252a889`](https://github.com/Arangarx/tutoring-notes/commit/0252a889). **In flight:** VERIFY-ACCT-1 cross-realm email (`feat/verify-acct-cross-realm-email`). |
