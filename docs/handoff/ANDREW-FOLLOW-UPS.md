...
| #7 | First-party instrumentation | **verify REJECT** — call-site Jest fix in flight on [`feat/product-events-chunk-1-tutor-funnel`](https://github.com/Arangarx/tutoring-notes/tree/feat/product-events-chunk-1-tutor-funnel) |
