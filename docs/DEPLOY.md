...
Tutors can self-serve at **`/signup`** (email + password or Google when OAuth is configured). New accounts land **WAITLISTED** until you approve them at **`/admin/tutor-approvals`**. For manual onboarding without self-serve:
