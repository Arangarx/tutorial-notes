...
| #5 | Native schedule CRUD | Branch [`feat/schedule-native-crud`](https://github.com/Arangarx/tutoring-notes/tree/feat/schedule-native-crud) @ [`5442d401`](https://github.com/Arangarx/tutoring-notes/commit/5442d401) — **independent verify in flight** |
